      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" v-for="spuSaleAttrValue in spuSaleAttr.spuSaleAttrValueList"
                  :key="spuSaleAttrValue.id" :class="{ active: spuSaleAttrValue.isChecked == 1 }"
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="buyNum" disabled>
...
export default {
  ...
  methods: {
    ...
    //加入购物车
    async addShopCart() {
      //派发action发请求，并根据加入购物车请求成功与否做进一步动作
      try {
        //成功
        await this.$store.dispatch('detail/updateShopCart', { skuid: this.$route.params.skuid, skuNum: this.buyNum })
        //路由跳转,并传参  简单的参数可以通过query或者params传递，复杂数据通过会话存储
