    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                ...
                <li :class="{ active: searchParams.order.indexOf('2') != -1 }" @click="changeOrder('2')">
                  <a>
                    价格
                    <span v-show="searchParams.order.indexOf('2') != -1">
                      <i v-if="searchParams.order.indexOf('asc') != -1">↑</i>
                      <i v-if="searchParams.order.indexOf('desc') != -1">↓</i>
                    </span>
                  </a>
                </li>
              </ul>
          ...
          <!-- 分页器 -->
          <!-- pageNo当前页数 pageSize每一页的数据条数 total总数据数量 continues连续页码数量，一般为奇数5或7 -->
...
export default {
  ...
  methods: {
    ...
    //点击面包屑x清空类名和id，并重新发请求，展示默认数据
    removeCategoryName() {
      //清空数据为undefined，不会把空参数带给服务器，提高性能
      this.searchParams.categoryName = undefined
      this.searchParams.category1Id = undefined
      this.searchParams.category2Id = undefined
      this.searchParams.category3Id = undefined
      this.getData()
      //地址栏query参数清空(params参数要留下)
    ...
    removeKeyword() {
      ...
      this.getData()
      //地址栏params参数清空，留下query参数
      this.$router.push({ name: 'search', query: this.$route.query })
      //通过全局事件总线通知Header组件清空搜索框keyword
